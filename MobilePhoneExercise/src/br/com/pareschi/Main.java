...
//        NOTE: If you get an error from the Evaluate class, it's most likely the constructor. Check if you've added a constructor or if the constructor has the right arguments.
        MobilePhone phone = new MobilePhone("982187090");
        phone.addNewContact(new Contact("Catherine", "4141324123"));
        phone.addNewContact(new Contact("Antonella", "2352344324"));
        phone.addNewContact(new Contact("Catherine", "242343423243"));
        phone.addNewContact(new Contact("Afrodite", "4141324123"));
        phone.addNewContact(new Contact("Daniel", "86789686687"));
        phone.updateContact(new Contact("Catherine", "4141324123"), new Contact("Catherine", "7474656464"));
        phone.printContacts();
        phone.removeContact(new Contact("Daniel", "86789686687"));
        phone.printContacts();
        System.out.println(phone.queryContact("Antonella"));
    }
}
