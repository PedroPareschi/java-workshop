...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:C:\\Users\\Pedro\\IdeaProjects\\Music\\" + DB_NAME;
    ...
    public static final String QUERY_ARTISTS_BY_NAME_ORDER = " ORDER BY " + COLUMN_ARTIST_NAME + " COLLATE NOCASE ";
    ...
    public boolean open() {
        try {
            ...
            insertIntoSongs = conn.prepareStatement(INSERT_SONG, Statement.RETURN_GENERATED_KEYS);
    ...
    public List<Artist> queryArtists(int sortOrder) {
        ...
        if (sortOrder != ORDER_BY_NONE) {
            sb.append(QUERY_ARTISTS_BY_NAME_ORDER);
...
//        select albums.name from albums inner join artists on albums.artist = artists._id WHERE artists.name = "Carole King" ORDER BY albums.name COLLATE NOCASE ASC
    ...
    public boolean updateArtisName(int id, String newName){
        try {
